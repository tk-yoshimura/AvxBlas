                ...
                foreach (uint iw in new int[] { 1, 2, 3, 4, 5, 8, 15, 16, 17, 28, 30, 32 }) {
                    foreach (uint kw in new int[] { 1, 3, 5 }) {
                        ...
                        foreach ((uint ic, uint oc) in new (uint, uint)[] { (1, 1), (2, 3), (3, 2), (4, 5), (5, 4), (8, 10), (10, 8),
                            ...
                            Convolute1D.Forward(n, ic, oc, iw, kw, PadMode.None, x_tensor, w_tensor, y_tensor);
                            ...
                            AssertError.Tolerance(y_expect, y_actual, 1e-10f, 1e-5f, ref max_err, $"NG: {ic},{oc},{iw},{kw},{n}");
                    ...
                    for (int ox = 0; ox < ow; ox++) {
                        for (int outch = 0; outch < outchannels; outch++) {
                            ...
                            for (int inch = 0; inch < inchannels; inch++) {
                                sum += x[inch, kx + ox, th] * w[inch, kx, outch];
                            }
