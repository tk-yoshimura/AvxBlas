...
namespace AvxBlasTest.Pool1DTest {
    ...
    public class MaxPoolingTest {
                    ...
                    foreach (uint kw in new int[] { 2, 3, 4, 5 }) {
                        foreach (uint sx in new int[] { 1, 2, 3, 4 }) {
                            ...
                            foreach (uint c in new uint[] { 1, 2, 3, 4, 5, 8, 10, 15, 16, 20, 31, 32, 33, 39, 40, 41, 47, 48, 49, 55, 56, 57, 63, 64, 65 }) {
                                ...
                                AssertError.Tolerance(y_expect, y_actual, 1e-10f, 1e-5f, ref max_err, $"NG: {iw},{sx},{kw},{n}");

                                Console.WriteLine($"OK: {iw},{sx},{kw},{n}");
                            }
                        }
                    }
                }
        ...
        public void ReferenceTest() {
            ...
            float[] xval = (new float[batch * inwidth * channels]).Select((_, idx) => (float)(idx * 4547 % 17)).ToArray();
            ...
            float[] y_expect = {
                5.00e+00f, 1.30e+01f, 1.60e+01f, 1.20e+01f, 1.50e+01f, 1.10e+01f, 1.40e+01f, 1.50e+01f, 6.00e+00f, 1.40e+01f, 5.00e+00f, 1.30e+01f, 1.60e+01f, 1.20e+01f,
                8.00e+00f, 1.60e+01f, 7.00e+00f, 1.50e+01f, 6.00e+00f, 1.40e+01f, 5.00e+00f, 1.30e+01f, 9.00e+00f, 1.20e+01f, 8.00e+00f, 1.60e+01f, 7.00e+00f, 1.50e+01f,
                1.10e+01f, 1.40e+01f, 1.00e+01f, 1.30e+01f, 9.00e+00f, 1.20e+01f, 8.00e+00f, 1.60e+01f, 1.20e+01f, 1.50e+01f, 1.10e+01f, 1.40e+01f, 1.00e+01f, 1.30e+01f,
                9.00e+00f, 0.00e+00f, 8.00e+00f, 1.60e+01f, 7.00e+00f, 1.50e+01f, 6.00e+00f, 1.40e+01f, 1.00e+01f, 1.30e+01f, 9.00e+00f, 1.20e+01f, 8.00e+00f, 1.60e+01f,
                1.20e+01f, 1.50e+01f, 1.10e+01f, 1.40e+01f, 1.00e+01f, 1.30e+01f, 9.00e+00f, 5.00e+00f, 1.30e+01f, 1.60e+01f, 1.20e+01f, 1.50e+01f, 1.10e+01f, 1.40e+01f,
                ...
                1.30e+01f, 9.00e+00f, 1.20e+01f, 8.00e+00f, 1.60e+01f, 7.00e+00f, 1.50e+01f, 6.00e+00f, 1.40e+01f, 5.00e+00f, 1.30e+01f, 4.00e+00f, 1.20e+01f, 3.00e+00f,
            };
