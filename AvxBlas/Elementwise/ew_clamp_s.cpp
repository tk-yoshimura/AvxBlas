...
int ew_clamp_s(
    ...
    while (r >= AVX2_FLOAT_STRIDE * 4) {
        ...
        y0 = _mm256_min_ps(_mm256_max_ps(x01, x02), x03);
        y1 = _mm256_min_ps(_mm256_max_ps(x11, x12), x13);
        y2 = _mm256_min_ps(_mm256_max_ps(x21, x22), x23);
        y3 = _mm256_min_ps(_mm256_max_ps(x31, x32), x33);
...
void AvxBlas::Elementwise::Clamp(UInt32 n, Array<float>^ x1, Array<float>^ x2, Array<float>^ x3, Array<float>^ y) {
    ...
    int ret = ew_clamp_s(n, x1_ptr, x2_ptr, x3_ptr, y_ptr);
