...
int ag_argmin_samples5to7_d(
    ...
    while (r >= AVX2_EPI32_STRIDE / 2) {
        ...
        _mm256_condmaskload_x2_pd(x_ptr + samples, x2, x3, mask, pinf);
        _mm256_condmaskload_x2_pd(x_ptr + samples * 2, x4, x5, mask, pinf);
        _mm256_condmaskload_x2_pd(x_ptr + samples * 3, x6, x7, mask, pinf);
...
int ag_argmin_samples9to11_d(
    ...
    while (r >= 2) {
        ...
        _mm256_condmaskload_x3_pd(x_ptr + samples, x3, x4, x5, mask, pinf);
