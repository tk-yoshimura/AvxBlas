...
__forceinline void copy_srcaligned_s(const uint n, infloats x_ptr, outfloats y_ptr, const __m256i mask) {
#ifdef _DEBUG
    if ((n & AVX2_FLOAT_REMAIN_MASK) == 0 || ((size_t)x_ptr % AVX2_ALIGNMENT) != 0) {
        throw std::exception();
    }
#endif // _DEBUG
...
__forceinline void copy_dstaligned_s(const uint n, infloats x_ptr, outfloats y_ptr, const __m256i mask) {
#ifdef _DEBUG
