...
__forceinline void kernelfma_n2_aligned_ss(
    ...
    while (r >= AVX2_FLOAT_STRIDE * 2) {
        ...
        _mm256_kahanfma_ps(
            x, _mm256_dilate2_imm0_ps(y01),
            s0, c0
        );
        _mm256_kahanfma_ps(
            x, _mm256_dilate2_imm1_ps(y01),
            s1, c1
        );
        _mm256_kahanfma_ps(
            x, _mm256_dilate2_imm0_ps(y23),
            s2, c2
        );
        _mm256_kahanfma_ps(
            x, _mm256_dilate2_imm1_ps(y23),
            s3, c3
        );
...
__forceinline void kernelfma_n3_aligned_ss(
    ...
    while (r >= AVX2_FLOAT_STRIDE) {
        ...
        _mm256_kahanfma_ps(
            x0, _mm256_permutevar8x32_ps(y, __perm_y0),
            s0, c0
        );
        _mm256_kahanfma_ps(
            x1, _mm256_permutevar8x32_ps(y, __perm_y1),
            s1, c1
        );
        _mm256_kahanfma_ps(
            x2, _mm256_permutevar8x32_ps(y, __perm_y2),
            s2, c2
        );
...
__forceinline void kernelfma_n3_unaligned_ss(
    ...
    if (r >= 5) { // 3 * r >= 6 + AVX2_FLOAT_STRIDE
        ...
        _mm256_kahanfma_ps(
            x, _mm256_dilate3_imm0_ps(y01),
            s0, c0
        );
        _mm256_kahanfma_ps(
            x, _mm256_and_ps(_mm256_dilate3_imm1_ps(y01), __mask6),
            s1, c1
        );
    ...
    if (r >= 3) { // 3 * r >= AVX_FLOAT_STRIDE
        ...
        _mm256_kahanfma_ps(
            x, _mm256_and_ps(_mm256_dilate3_imm0_ps(y0), __mask6),
            s0, c0
        );
...
__forceinline void kernelfma_n4_aligned_ss(
    ...
    while (r >= 8) {
        ...
        _mm256_kahanfma_ps(
            x, _mm256_dilate4_imm0_ps(y),
            s0, c0
        );
        _mm256_kahanfma_ps(
            x, _mm256_dilate4_imm1_ps(y),
            s1, c1
        );
        _mm256_kahanfma_ps(
            x, _mm256_dilate4_imm2_ps(y),
            s2, c2
        );
        _mm256_kahanfma_ps(
            x, _mm256_dilate4_imm3_ps(y),
            s3, c3
        );
