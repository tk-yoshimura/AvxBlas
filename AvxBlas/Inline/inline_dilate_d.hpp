...
__forceinline __m256d _mm256_dilate3_imm0_pd(__m256d x) {
    const __m256d ret = _mm256_permute4x64_pd(x, _MM_PERM_DAAA);
...
__forceinline __m256d _mm256_dilate3_imm1_pd(__m256d x) {
    const __m256d ret = _mm256_permute4x64_pd(x, _MM_PERM_DBBB);
...
__forceinline __m256d _mm256_dilate3_imm2_pd(__m256d x) {
    const __m256d ret = _mm256_permute4x64_pd(x, _MM_PERM_DCCC);
...
__forceinline __m256d _mm256_dilate4_imm0_pd(__m256d x) {
    const __m256d ret = _mm256_permute4x64_pd(x, _MM_PERM_AAAA);
...
__forceinline __m256d _mm256_dilate4_imm1_pd(__m256d x) {
    const __m256d ret = _mm256_permute4x64_pd(x, _MM_PERM_BBBB);
...
__forceinline __m256d _mm256_dilate4_imm2_pd(__m256d x) {
    const __m256d ret = _mm256_permute4x64_pd(x, _MM_PERM_CCCC);
...
__forceinline __m256d _mm256_dilate4_imm3_pd(__m256d x) {
    const __m256d ret = _mm256_permute4x64_pd(x, _MM_PERM_DDDD);
