        ...
        for (uint oy = 0, isy = 0; oy < oh; oy++, isy += sy) {
            for (uint ox = 0, isx = 0; ox < ow; ox++, isx += sx) {
                ...
                for (uint kx = 1 % ekw, ky = 1 / ekw; ky < ekh; kx++, ky += kx / ekw, kx %= ekw) {
                    ...
                    maxpooliter_n32x_s(c, x_ptr + c * (ix + iw * iy), y_ptr + c * (ox + ow * oy));
                }
            }
        }
        ...
        for (uint oy = 0, isy = 0; oy < oh; oy++, isy += sy) {
            for (uint ox = 0, isx = 0; ox < ow; ox++, isx += sx) {
                ...
                for (uint kx = 1 % ekw, ky = 1 / ekw; ky < ekh; kx++, ky += kx / ekw, kx %= ekw) {
                    ...
                    maxpooliter_aligned_s(c, x_ptr + c * (ix + iw * iy), y_ptr + c * (ox + ow * oy));
                }
            }
        }
        ...
        for (uint oy = 0, isy = 0; oy < oh; oy++, isy += sy) {
            for (uint ox = 0, isx = 0; ox < ow; ox++, isx += sx) {
                ...
                for (uint kx = 1 % ekw, ky = 1 / ekw; ky < ekh; kx++, ky += kx / ekw, kx %= ekw) {
                    ...
                    maxpooliter_unaligned_s(c, x_ptr + c * (ix + iw * iy), y_ptr + c * (ox + ow * oy), mask);
                }
            }
        }
